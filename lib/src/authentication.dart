...
class Authentication extends StatelessWidget {
  ...
  final AplicationLoginState loginState;
  final String email;
  ...
  Widget build(BuildContext context) {
    switch (loginState){
      ...
      case AplicationLoginState.emailAdres:
        return EmailForm(
          callback: (email) => verifyEmail(
            email, (e) => _showErrorDialog(context, 'Invalid email', e)
          )
        );
      case AplicationLoginState.register:
        return RegisterForm(
          email: email,
          cancel: (){
            cancelRegistration();
      ...
      case AplicationLoginState.pasword:
        return PasswordForm(
            email: email,
